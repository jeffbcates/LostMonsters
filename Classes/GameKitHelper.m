...
-(void) showLeaderboard:(NSString *) leaderboardID {
	...
	//set the leaderboard id if specified
	if ( leaderboardID != nil ) [leaderboardVC setCategory:leaderboardID];
	
	//if leadberboard view is valid, show it
...
-(void) showFriendRequest {
	...
	//create the friend request dialog
	GKFriendRequestComposeViewController* friendVC = [[[GKFriendRequestComposeViewController alloc] init] autorelease];
	
	//if leadberboard view is valid, show it
	if (friendVC != nil) {
		//friendVC.friendRequestDelegate = self;
		[self presentViewController:friendVC];
	}
	
}

//TODO: this needs to show the list of leaderboards and not the first leaderboard in the list
